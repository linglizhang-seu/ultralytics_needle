    ...
    for needle in valid_needles:
        ...
        for tip in tips:
            ...
            if needle_poly:
                ...
                n_box = needle['box']
                # 扩大一点针身框
                if (tip_center[0] > n_box[0]-10 and tip_center[0] < n_box[2]+10 and
                    tip_center[1] > n_box[1]-10 and tip_center[1] < n_box[3]+10):
                    is_contained = True
        ...
        if not is_associated:
            ...
            if tip['conf'] > 0.6: # 对于孤立针尖，要求极高置信度才认为是真的
                 final_detections.append({
                    "type": "tip_only",
                    "tip_box": tip['box'],
                    "note": "High confidence tip without body"
                })
            else:
                # 认为是漂浮物误检，丢弃
