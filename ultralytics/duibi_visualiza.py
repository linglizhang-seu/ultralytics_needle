...
if __name__ == '__main__':
    ...
    yolov11_result_csv = r'E:\Human_Projects\yolov11\ultralytics-main\ultralytics\runs\segment\train6_origin_yolov11n\results.csv'
    dinov3_result_csv = r'E:\Human_Projects\yolov11\ultralytics-main\ultralytics\runs\segment\train7_my_experiment_6\results.csv'
    ...
    for idx, (ax, title, key) in enumerate(zip(axs, metric_titles, metric_keys)):
        ...
        ax.plot(x_dino, pd.to_numeric(dinov3_result_data[dino_cols[key]], errors='coerce'), label='dino_yolo', linewidth=2)
