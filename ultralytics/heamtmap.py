    ...
    def process(self, img_path, save_path):
        ...
        if self.renormalize and self.task in ["detect", "segment", "pose"]:
            cam_image = self.renormalize_cam_in_bounding_boxes(
                pred.boxes.xyxy.cpu().detach().numpy().astype(np.int32), img_vis, grayscale_cam
            )
        if self.show_result:
            cam_image = pred.plot(
                img=cam_image,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--input",
        type=str,
        default=r"E:\Human_Projects\yolov11\ultralytics-main\ultralytics\cell_20240104_093743.tif",
    ...
    model(
        r"E:\Human_Projects\yolov11\ultralytics-main\ultralytics\datasets\images\test",
        r"E:\Human_Projects\yolov11\ultralytics-main\ultralytics\heatmapresult2",
    )
